...
if(!class_exists('ossy_Extended_Menu_Walker') ) {
    ...
    class ossy_Extended_Menu_Walker extends Walker_Nav_Menu
    {
        ...
        public static function fallback( $args = array() ) {
            ...
            $fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'. __('Add a menu', 'ossy'). '</a></li>';
            if ( $container )
                $fb_output .= '</' . $container . '>';
            echo $fb_output;

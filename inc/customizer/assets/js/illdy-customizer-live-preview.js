...
( function( $ ) {
	/* Company text logo */
	wp.customize( 'ossy_text_logo', function( value ) {
		value.bind( function( newval ) {
			if( wp.customize._value.ossy_img_logo() == '' ) {
	...
	/* Company image logo */
	wp.customize( 'ossy_img_logo', function( value ) {
		value.bind( function( newval ) {
			if( newval !== '' ) {
				$( '#header .top-header .header-logo' ).empty();
				$( '#header .top-header .header-logo' ).prepend( '<img src="" alt="'+ wp.customize._value.ossy_text_logo +'" title="'+ wp.customize._value.ossy_text_logo +'" />' );
				$( '#header .top-header .header-logo img' ).attr( 'src', newval );
			} else {
				$( '#header .top-header .header-logo' ).text( wp.customize._value.ossy_text_logo() );
			}
		} );
	} );

	/* Facebook URL */
	wp.customize( 'ossy_contact_bar_facebook_url', function( value ) {
		value.bind( function( newval ) {
	...
	/* Twitter URL */
	wp.customize( 'ossy_contact_bar_twitter_url', function( value ) {
		value.bind( function( newval ) {
	...
	/* LinkedIn URL */
	wp.customize( 'ossy_contact_bar_linkedin_url', function( value ) {
		value.bind( function( newval ) {
	...
	/* email */
	wp.customize( 'ossy_email', function( value ) {
		value.bind( function( newval ) {
	...
	/* phone number */
	wp.customize( 'ossy_phone', function( value ) {
		value.bind( function( newval ) {
	...
	// Address 1
	wp.customize( 'ossy_address1', function( value ) {
		value.bind( function( newval ) {
	...
	// Address 1
	wp.customize( 'ossy_address2', function( value ) {
		value.bind( function( newval ) {
	...
	/* Footer Image Logo */
	wp.customize( 'ossy_img_footer_logo', function( value ) {
		value.bind( function( newval ) {
			if( newval !== '' ) {
	...
	/* Footer Copyright */
	wp.customize( 'ossy_footer_copyright', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'ossy_general_footer_display_copyright', function( value ) {
		value.bind( function( newval ) {
			if( newval == true ) {
	...
	wp.customize( 'ossy_enable_post_posted_on_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	wp.customize( 'ossy_enable_post_tags_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	wp.customize( 'ossy_enable_post_comments_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	wp.customize( 'ossy_enable_author_box_blog_posts', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	/* Facebook visibility */
	wp.customize( 'ossy_facebook_visibility', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	/* Twitter visibility */
	wp.customize( 'ossy_twitter_visibility', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	/* LinkedIN visibility */
	wp.customize( 'ossy_linkein_visibility', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Image
	wp.customize( 'ossy_jumbotron_general_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	wp.customize( 'ossy_jumbotron_general_first_row_from_title', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	wp.customize( 'ossy_jumbotron_general_second_row_from_title', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	wp.customize( 'ossy_jumbotron_general_third_row_from_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_jumbotron_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// First button text
	wp.customize( 'ossy_jumbotron_general_first_button_title', function( value ) {
		value.bind( function( newval ) {
	...
	// First button URL
	wp.customize( 'ossy_jumbotron_general_first_button_url', function( value ) {
		value.bind( function( newval ) {
	...
	// Second button text
	wp.customize( 'ossy_jumbotron_general_second_button_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Second button URL
	wp.customize( 'ossy_jumbotron_general_second_button_url', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_about_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_about_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_about_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_projects_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_projects_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_projects_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_testimonials_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_testimonials_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Background Image
	wp.customize( 'ossy_testimonials_general_background_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	// Show this section
	wp.customize( 'ossy_services_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_services_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_services_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_latest_news_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_latest_news_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_latest_news_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Button Text
	wp.customize( 'ossy_latest_news_button_text', function( value ) {
		value.bind( function( newval ) {
	...
	// Button URL
	wp.customize( 'ossy_latest_news_button_url', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_counter_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Type of Background
	wp.customize( 'ossy_counter_background_type', function( value ) {
		value.bind( function( newval ) {
			if( newval == 'image' ) {
				$( '#counter' ).css( 'background-color', '' );
				$( '#counter' ).css( 'background-image', 'url('+ wp.customize._value.ossy_counter_background_image() +')' );
			} else if( newval == 'color' ) {
				$( '#counter' ).css( 'background-image', '' );
				$( '#counter' ).css( 'background-color', 'color:' + wp.customize._value.ossy_counter_background_color() );
			}
		} );
	} );

	// Image
	wp.customize( 'ossy_counter_background_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	// Color
	wp.customize( 'ossy_counter_background_color', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_team_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_team_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_team_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Show this section
	wp.customize( 'ossy_contact_us_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
	...
	// Title
	wp.customize( 'ossy_contact_us_general_title', function( value ) {
		value.bind( function( newval ) {
	...
	// Entry
	wp.customize( 'ossy_contact_us_general_entry', function( value ) {
		value.bind( function( newval ) {
	...
	// Address Title
	wp.customize( 'ossy_contact_us_general_address_title', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'ossy_contact_us_general_customer_support_title', function( value ) {
		value.bind( function( newval ) {

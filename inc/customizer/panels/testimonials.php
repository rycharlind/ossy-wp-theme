<?php
// Set Panel ID
$panel_id = 'ossy_panel_testimonials';
...
$wp_customize->add_panel( $panel_id,
    array(
        ...
        'theme_supports'    => '',
        'title'             => __( 'Testimonials', 'ossy' ),
        'description'       => __( 'Control various options for testimonials section from front page.', 'ossy' ),
    )
);
*/
...
$wp_customize->add_section( $prefix . '_testimonials_general' ,
    array(
        'title'         => __( 'Testimonials Section', 'ossy' ),
        'description'   => __( 'Control various options for testimonials section from front page.', 'ossy' ),
        'priority'      => 104
...
$wp_customize->add_control(
    ...
    array(
        ...
        'priority'  => 1,
        'active_callback'   => 'ossy_is_active_jetpack_testimonials'
    )
);
...
$wp_customize->add_control(
    new ossy_Text_Custom_Control(
        ...
        array(
            ...
            'description'       => __( 'In order to get the Testimonials module working, you will have to install JetPack and enable Custom Post Type: Testimonials.', 'ossy' ),
            'section'           => $prefix .'_testimonials_general',
            'settings'          => $prefix . '_testimonials_general_text',
            'priority'          => 5,
            'active_callback'   => 'ossy_is_not_active_jetpack_testimonials'
        )
    )
);
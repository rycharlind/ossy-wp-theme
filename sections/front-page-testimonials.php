...
if ( current_user_can( 'edit_theme_options' ) ) {
	$general_title = get_theme_mod( 'ossy_testimonials_general_title', __( 'Testimonials', 'ossy' ) );
	$general_background_image = get_theme_mod( 'ossy_testimonials_general_background_image', '' );
	$number_of_posts = get_theme_mod( 'ossy_testimonials_number_of_posts', absint( 4 ) );
}else{
	$general_title = get_theme_mod( 'ossy_testimonials_general_title' );
	$general_background_image = get_theme_mod( 'ossy_testimonials_general_background_image' );
	$number_of_posts = get_theme_mod( 'ossy_testimonials_number_of_posts', absint( 4 ) );	
}
								...
								<?php while( $jetpack_testimonial_query->have_posts() ): ?>
									...
									<div class="carousel-testimonial" style="<?php if( $count_posts->publish == 1 ): echo 'margin-bottom: 42px;'; endif; ?>">
										<div class="testimonial-image">
											<?php the_post_thumbnail( $post->ID, 'ossy-front-page-testimonials' ); ?>
					...
					<div class="col-sm-10 col-sm-offset-1 no-padding">
						<div class="testimonials-carousel owl-carousel-enabled">
							<div class="carousel-testimonial">
								<div class="testimonial-image">
									<img src="<?php echo get_template_directory_uri(); ?>/layout/images/front-page/front-page-testimonial-1.jpg" alt="<?php _e( 'Jane Smith', 'ossy' ); ?>" title="<?php _e( 'Jane Smith', 'ossy' ); ?>" />
								</div><!--/.testimonial-image-->
								<div class="testimonial-content">
									<blockquote><q><?php _e( 'Awesome theme with great design and helpfull support. If you do not know how to code your own WordPress theme, but you still want a good-looking website for your business, ossy might be exactly what you need. It is a slick theme with a lot of of features to choose from. You can customize whatever section you  want and you can rest assure that no matter what device your website is viewed on it looks  great.', 'ossy' ); ?></q></blockquote>
								</div><!--/.testimonial-content-->
								<div class="testimonial-meta">
									<?php _e( 'Jane Smith', 'ossy' ); ?>
								</div><!--/.testimonial-meta-->
							</div><!--/.carousel-testimonial-->
							<div class="carousel-testimonial">
								<div class="testimonial-image">
									<img src="<?php echo get_template_directory_uri(); ?>/layout/images/front-page/front-page-testimonial-2.jpg" alt="<?php _e( 'Jane Smith', 'ossy' ); ?>" title="<?php _e( 'Jane Smith', 'ossy' ); ?>" />
								</div><!--/.testimonial-image-->
								<div class="testimonial-content">
									<blockquote><q><?php _e( 'Awesome theme with great design and helpfull support. If you do not know how to code your own WordPress theme, but you still want a good-looking website for your business, ossy might be exactly what you need. It is a slick theme with a lot of of features to choose from. You can customize whatever section you  want and you can rest assure that no matter what device your website is viewed on it looks  great.', 'ossy' ); ?></q></blockquote>
								</div><!--/.testimonial-content-->
							...
							<div class="carousel-testimonial">
								<div class="testimonial-image">
									<img src="<?php echo get_template_directory_uri(); ?>/layout/images/front-page/front-page-testimonial-3.jpg" alt="<?php _e( 'Jane Smith', 'ossy' ); ?>" title="<?php _e( 'Jane Smith', 'ossy' ); ?>" />
								</div><!--/.testimonial-image-->
								<div class="testimonial-content">
									<blockquote><q><?php _e( 'Awesome theme with great design and helpfull support. If you do not know how to code your own WordPress theme, but you still want a good-looking website for your business, ossy might be exactly what you need. It is a slick theme with a lot of of features to choose from. You can customize whatever section you  want and you can rest assure that no matter what device your website is viewed on it looks  great.', 'ossy' ); ?></q></blockquote>
								</div><!--/.testimonial-content-->
							...
							<div class="carousel-testimonial">
								<div class="testimonial-image">
									<img src="<?php echo get_template_directory_uri(); ?>/layout/images/front-page/front-page-testimonial-4.jpg" alt="<?php _e( 'Jane Smith', 'ossy' ); ?>" title="<?php _e( 'Jane Smith', 'ossy' ); ?>" />
								</div><!--/.testimonial-image-->
								<div class="testimonial-content">
									<blockquote><q><?php _e( 'Awesome theme with great design and helpfull support. If you do not know how to code your own WordPress theme, but you still want a good-looking website for your business, ossy might be exactly what you need. It is a slick theme with a lot of of features to choose from. You can customize whatever section you  want and you can rest assure that no matter what device your website is viewed on it looks  great.', 'ossy' ); ?></q></blockquote>
								</div><!--/.testimonial-content-->

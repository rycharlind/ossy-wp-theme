...
// Set Panel ID
$panel_id = 'ossy_panel_blog_options';
...
$site_title->title = __( 'Blog Jumbotron Titles', 'ossy' );
$site_title->panel = $panel_id;

// Change priority for Site Title
$site_title           = $wp_customize->get_control( 'blogname' );
$site_title->label    = __( 'Default site title', 'ossy' );
$site_title->priority = 15;

// Change priority for Site Tagline
$site_title              = $wp_customize->get_control( 'blogdescription' );
$site_title->label       = __( 'Default site tagline', 'ossy' );
$site_title->description = __( 'The tagline will be shown on archive pages, in the jumbotron right below the title.', 'ossy' );
$site_title->priority    = 17;

// site title
$site_logo              = $wp_customize->get_control( 'blogname' );
$site_logo->description = __( 'This is the default WordPress title. This will be used in the jumbotron, if you don\'t specify a custom title.', 'ossy' );

$wp_customize->add_panel( $panel_id, array(
	'priority'       => 2,
	'capability'     => 'edit_theme_options',
	'theme_supports' => '',
	'title'          => __( 'Blog Options', 'ossy' ),
	'description'    => __( 'You can change blog options ', 'ossy' ),
) );

//
$wp_customize->get_section( 'header_image' )->panel = $panel_id;
$wp_customize->get_section( 'header_image' )->title = __( 'Blog Archive Header Image', 'ossy' );
...
$wp_customize->add_control(
    $prefix . '_archive_page_background_stretch',
    array(
        'label'         => __( 'Background Stretch', 'ossy' ),
        'type'          => 'select',
...
$wp_customize->add_section( $prefix . '_blog_global_section', array(
	'title'       => __( 'Single Post Options', 'ossy' ),
	'description' => __( 'This section allows you to control how certain elements are displayed on the blog single page.', 'ossy' ),
	'panel'       => $panel_id,
) );
...
$wp_customize->add_control( $prefix . '_enable_post_posted_on_blog_posts', array(
	'type'        => 'checkbox',
	'label'       => __( 'Posted on meta on single blog post', 'ossy' ),
	'description' => __( 'This will disable the posted on zone as well as the author name', 'ossy' ),
...
$wp_customize->add_control( $prefix . '_enable_post_category_blog_posts', array(
	'type'        => 'checkbox',
	'label'       => __( 'Category meta on single blog post', 'ossy' ),
	'description' => __( 'This will disable the posted in zone.', 'ossy' ),
	// 'section'       => $prefix.'_blog_global_section',
) );
...
$wp_customize->add_control( $prefix . '_enable_post_tags_blog_posts', array(
	'type'        => 'checkbox',
	'label'       => __( 'Tags meta on single blog post', 'ossy' ),
	'description' => __( 'This will disable the tagged with zone.', 'ossy' ),
	'section'     => $prefix . '_blog_global_section',
) );
...
$wp_customize->add_control( $prefix . '_enable_post_comments_blog_posts', array(
	'type'        => 'checkbox',
	'label'       => __( 'Coments meta on single blog post', 'ossy' ),
	'description' => __( 'This will disable the comments header zone.', 'ossy' ),
	'section'     => $prefix . '_blog_global_section',
) );
...
$wp_customize->add_control( $prefix . '_enable_author_box_blog_posts', array(
	'type'        => 'checkbox',
	'label'       => __( 'Author info box on single blog post', 'ossy' ),
	'description' => __( 'Displayed right at the end of the post', 'ossy' ),
	'section'     => $prefix . '_blog_global_section',
) );
...
$wp_customize->add_control( $prefix . '_custom_blog_archive_title', array(
	'label'       => __( 'Use a custom title on the blog archive.', 'ossy' ),
	'description' => __( 'Will be displayed in the Jumbotron as a custom title. Only used on the blog archive, all other pages default to the WordPress Core functionality where the archive title is displayed.', 'ossy' ),
